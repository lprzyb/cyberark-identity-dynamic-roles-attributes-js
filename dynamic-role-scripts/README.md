...
> **Choosing the right scripting context?** See [README.md](../README.md) for a comparison of Dynamic Roles, Application Policy Scripts, and SAML Scripts — including when to use each and why some attributes are unavailable here.
